...
const FeaturedCollections = () => {
    ...
    const { index, onNext, onPrevious } = useCarousel(products?.length)
        ...
        <>
            <section >
                <div className="featured-collections">
                    <article>
                        <div className="featured-collection_head">
                            <h1 className="featured-collection_title">Featured Collections</h1>
                            <div className="featured-collection_arrow">
                                <svg className="featured-collection_arrow-buttons" onClick={onPrevious} width="18" height="29" viewBox="0 0 18 29" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <svg className="featured-collection_arrow-buttons" onClick={onNext} width="18" height="29" viewBox="0 0 18 29" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <article>
                        <div className="featured-collection_products-carousel">
                            <div className="featured-collection_products-track" style={{ transform: `translateX(-${index * 420}px)` }}>
                                {products?.map((product) => (
                                    <div className="featured-collection_products-card" key={product._id}>
                                        <div className="featured-collection_products-images">
                                            <Link to={`/product/${product._id}`}><img src={`http://localhost:5000/uploads/${product.image}`} alt="" className='featured-collection_products-image' /></Link>
                                        ...
                                        <div className="featured-collection_products-text">

                                            <h1 className="featured-collection_products-title" >{product.name}</h1>
                                            <div className="featured-collection_products-price-group">
                                                <h1 className="featured-collection_products-price-new">Rs ₹{product.price}</h1>
                                                <h1 className="featured-collection_products-price-old">Rs ₹{product.salePrice}</h1>
                                            </div>
                                        </div>
                                        <Link to='/cart' className='featured-collection_products-button' onClick={() => onCartAdd(product._id)}>Add To Cart</Link>
                                    </div>
                                ))}
                            </div>
                        </div>
