    ...
    return (
        <section>
            <div className="offer-zone">
                <article>
                    <div className="offer-zone_head">
                        <h1 className='offer-zone_title'>Offers Zone</h1>
                        <div className="offer-zone_arrows">
                            <svg className="offer-zone_arrow-buttons" onClick={onPrevious} width="18" height="29" viewBox="0 0 18 29" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <svg className="offer-zone_arrow-buttons" onClick={onNext} width="18" height="29" viewBox="0 0 18 29" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <article>
                    <div className="offer-zone_products-carousel">
                        <div className="offer-zone_products-track" style={{ transform: `translateX(-${index * 420}px)` }}>
                            {products?.map((product) => (
                                <div className="offer-zone_products-card" key={product._id}>
                                    <div className="offer-zone_products-images">
                                        <Link to={`/product/${product._id}`}><img src={`http://localhost:5000/uploads/${product.image}`} className='featured-collection_products-image' alt="" /></Link>
                                    ...
                                    <div className="offer-zone_products-text">
                                        <h1 className="offer-zone_products-title">{product.name}</h1>
                                        <div className="offer-zone_products-price-group">
                                            <h1 className="offer-zone_products-price-new">Rs ₹{product.price}</h1>
                                            <h1 className="offer-zone_products-price-old">Rs ₹{product.salePrice}</h1>
                                        </div>

                                    </div>
                                    <Link to='/cart' className='offer-zone_products-button' onClick={() => onCartAdd(product._id)}>Add To Cart</Link>
                                </div>
                            ))}
                        </div>
